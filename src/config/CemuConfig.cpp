...
XMLConfigParser CemuConfig::Load(XMLConfigParser& parser)
{
	...
	emulated_usb_devices.emulate_skylander_portal_hybrid = usbdevices.get("EmulateSkylanderPortalHybrid", emulated_usb_devices.emulate_skylander_portal_hybrid);
...
XMLConfigParser CemuConfig::Save(XMLConfigParser& parser)
{
	...
	usbdevices.set("EmulateSkylanderPortalHybrid", emulated_usb_devices.emulate_skylander_portal_hybrid.GetValue());
